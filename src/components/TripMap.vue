...
export default {
  ...
  setup(props) {
    ...
    onMounted(async () => {
      //   const loader = new google.maps.maps.ScriptLoader()
      ...
      function startTrip(index) {
        ...
        directionsService.route(request, function (result, status) {
          if (status == 'OK') {
            ...
            let i = 0
            let speed = 50 // Higher number = slower
...
<template>
  <div class="map">
    <div ref="mapDiv" style="width: 1000px; height: 660px; border: 1px solid yellow" />
  </div>
</template>
